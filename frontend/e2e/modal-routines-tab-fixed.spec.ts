...
test.describe('Modal Routines Tab Fixed', () => {
  test('should test modal by switching to routines tab', async ({ page }) => {
    ...
    if (await routinesTab.isVisible()) {
      ...
      if (await createButton.isVisible()) {
        ...
        if (await modal.isVisible()) {
          ...
          await modal.screenshot({ path: 'modal-routines-tab-working.png' });
        } else {

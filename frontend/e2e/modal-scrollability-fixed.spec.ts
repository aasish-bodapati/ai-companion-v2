...
test.describe('Modal Scrollability Fixed Test', () => {
  test('should test modal scrollability with forced content', async ({ page }) => {
    ...
    await modal.screenshot({ path: 'modal-scrollability-test.png' });
  });
});

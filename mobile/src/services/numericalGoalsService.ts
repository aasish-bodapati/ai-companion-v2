...
class NumericalGoalsService {
  ...
  async setGoals(goals: NumericalGoal[]): Promise<void> {
    try {
      ...
      console.error('Failed to save numerical goals to storage:', error);
      throw error;
    }
  }
  ...
  async getGoals(): Promise<NumericalGoal[]> {
    try {
      ...
      console.error('Failed to load numerical goals from storage:', error);
      return [];
    }
  }
  ...
  async clearGoals(): Promise<void> {
    try {
      ...
      console.error('Failed to clear numerical goals from storage:', error);
      throw error;
    }
  }
  ...
  private async calculateDailyProtein(): Promise<number> {
    try {
      ...
      console.error('Error calculating daily protein:', error);
      return 0;
    }
  }
  ...
  private async calculateDailyWater(): Promise<number> {
    try {
      ...
      console.error('Error calculating daily water:', error);
      return 0;
    }
  }
  ...
  private async calculateHydrationConsistency(): Promise<number> {
    try {
      ...
      console.error('Error calculating hydration consistency:', error);
      return 0;
    }
  }
  ...
  private async calculateDailyVegetables(): Promise<number> {
    try {
      ...
      console.error('Error calculating daily vegetables:', error);
      return 0;
    }
  }
  ...
  private async calculateDailyFruits(): Promise<number> {
    try {
      ...
      console.error('Error calculating daily fruits:', error);
      return 0;
    }
  }
  ...
  private async calculateWeeklyProcessedFood(): Promise<number> {
    try {
      ...
      console.error('Error calculating weekly processed food:', error);
      return 0;
    }
  }

        ...
        <View style={styles.goalsGrid}>
            ...
            <View style={styles.goalRow}>
              ...
              <Text style={styles.goalValue}>
                {typeof goalData.targetAttributes.sleepDuration === 'object' 
                  ? `${goalData.targetAttributes.sleepDuration.recommended} hours/night`
                  : `${goalData.targetAttributes.sleepDuration} hours/night`
                }
              </Text>
            </View>
          )}
            ...
            <View style={styles.goalRow}>
              ...
              <Text style={styles.goalValue}>
                {typeof goalData.targetAttributes.dailySteps === 'object'
                  ? `${goalData.targetAttributes.dailySteps.recommended.toLocaleString()}/day`
                  : `${goalData.targetAttributes.dailySteps.toLocaleString()}/day`
                }
              </Text>
            </View>
          )}
          {goalData.targetAttributes.recoveryDays && (
            <View style={styles.goalRow}>
              ...
              <Text style={styles.goalValue}>
                {typeof goalData.targetAttributes.recoveryDays === 'object'
                  ? `${goalData.targetAttributes.recoveryDays.recommended} days/week`
                  : `${goalData.targetAttributes.recoveryDays} days/week`
                }
              </Text>
            </View>
          )}
            ...
            <View style={styles.goalRow}>
              ...
              <Text style={styles.goalValue}>
                {typeof goalData.targetAttributes.workoutFrequency === 'object'
                  ? `${goalData.targetAttributes.workoutFrequency.recommended} days`
                  : `${goalData.targetAttributes.workoutFrequency} days`
                }
              </Text>
            </View>
          )}
          {goalData.targetAttributes.cardioMinutes && (
            <View style={styles.goalRow}>
              <Text style={styles.goalLabel}>Cardio</Text>
              <Text style={styles.goalValue}>
                {typeof goalData.targetAttributes.cardioMinutes === 'object'
                  ? `${goalData.targetAttributes.cardioMinutes.recommended} min/week`
                  : `${goalData.targetAttributes.cardioMinutes} min/week`
                }
              </Text>
            </View>
          )}
          {goalData.targetAttributes.strengthSessions && (
            <View style={styles.goalRow}>
              <Text style={styles.goalLabel}>Strength Sessions</Text>
              <Text style={styles.goalValue}>
                {typeof goalData.targetAttributes.strengthSessions === 'object'
                  ? `${goalData.targetAttributes.strengthSessions.recommended} sessions/week`
                  : `${goalData.targetAttributes.strengthSessions} sessions/week`
                }
              </Text>
            </View>
          )}
          {goalData.targetAttributes.waterGoal && (
            <View style={styles.goalRow}>
              <Text style={styles.goalLabel}>Water Goal</Text>
              <Text style={styles.goalValue}>
                {typeof goalData.targetAttributes.waterGoal === 'object'
                  ? `${goalData.targetAttributes.waterGoal.recommended}L/day`
                  : `${goalData.targetAttributes.waterGoal}L/day`
                }
              </Text>
            </View>
          )}
                  ...
                  >
                    <View style={styles.bodyTypeGoalHeader}>
                      ...
                      <View style={styles.bodyTypeGoalInfo}>
                        <Text style={styles.bodyTypeGoalTitle}>{bodyTypeGoalName || 'Loading...'}</Text>
    ...
    >
      ...
      <View style={styles.metricsSection}>
        ...
        <View style={styles.metricsGrid}>
          ...
          <View style={styles.metricCard}>
            <Ionicons name="male-female-outline" size={24} color="#8b5cf6" />
            <Text style={styles.metricValue}>

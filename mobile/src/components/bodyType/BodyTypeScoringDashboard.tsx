...
import { BodyTypeScoringService, ScoringResult } from '../../services/BodyTypeScoringService';
import { DailyLog, WeeklyLog, BodyTypeGoal, UserAttributes } from '../../services/ConsolidatedGoalsService';

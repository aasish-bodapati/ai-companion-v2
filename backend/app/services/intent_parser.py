...
class IntentParser:
        ...
        for pattern in water_patterns:
            ...
            if match:
                ...
                return {
                    ...
                    "params": {"amount_ml": amount_ml, "when": datetime.now().isoformat()},
                }
    ...
    def _parse_workout_log(self, text: str) -> Optional[Dict[str, Any]]:
        ...
        for match in matches:
            ...
            exercises.append({"name": exercise_name, "sets": sets, "weight_kg": weight_kg})
        ...
        for match in matches:
            ...
            exercise = {"name": activity, "distance_km": distance_km}
            if duration:
        ...
        if exercises:
            return {
                ...
                "params": {"exercises": exercises, "when": datetime.now().isoformat()},
            }
    ...
    def _detect_goal_category(self, goal_text: str) -> str:
        ...
        if any(
            word in text_lower for word in ["lift", "bench", "squat", "deadlift", "press", "strong"]
        ):
            return "strength"
